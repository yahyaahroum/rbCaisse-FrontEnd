...
@Component({
  selector: 'app-add-paiement-elec-eau',
  templateUrl: './add-paiement-elec-eau.component.html',
  styleUrls: ['./add-paiement-elec-eau.component.css']
})
export class AddPaiementElecEauComponent {
