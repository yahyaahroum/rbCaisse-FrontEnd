...
@Component({
  selector: 'app-update-paiement-elec-eau',
  templateUrl: './update-paiement-elec-eau.component.html',
  styleUrls: ['./update-paiement-elec-eau.component.css']
})
export class UpdatePaiementElecEauComponent {
