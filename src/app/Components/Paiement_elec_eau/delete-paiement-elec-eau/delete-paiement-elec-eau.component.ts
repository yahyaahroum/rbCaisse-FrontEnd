...
@Component({
  selector: 'app-delete-paiement-elec-eau',
  templateUrl: './delete-paiement-elec-eau.component.html',
  styleUrls: ['./delete-paiement-elec-eau.component.css']
})
export class DeletePaiementElecEauComponent {
