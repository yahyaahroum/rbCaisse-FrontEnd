...
@Component({
  selector: 'app-update-paiement-loye',
  templateUrl: './update-paiement-loye.component.html',
  styleUrls: ['./update-paiement-loye.component.css']
})
export class UpdatePaiementLoyeComponent {
