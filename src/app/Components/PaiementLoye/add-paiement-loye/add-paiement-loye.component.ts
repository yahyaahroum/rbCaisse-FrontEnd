...
@Component({
  selector: 'app-add-paiement-loye',
  templateUrl: './add-paiement-loye.component.html',
  styleUrls: ['./add-paiement-loye.component.css']
})
export class AddPaiementLoyeComponent {
